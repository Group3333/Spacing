...
class PlaceCollectionViewCell: UICollectionViewCell {
    ...
    override func prepareForReuse() {
        [categoryLabel,titleLabel,rateLabel,hourPriceLabel,discountHourPriceLabel ,addressLabel].forEach{
            $0?.text = ""
        }
    ...
    func configureBookView(bookPlace: BookPlace){
        ...
        spaceImageView.layer.borderColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.05).cgColor
        spaceImageView.layer.borderWidth = 2
        [hourLabel,hourPriceLabel,eventLabel,discountHourPriceLabel].forEach{
            $0?.isHidden = true
        }
        let view = UIView()
