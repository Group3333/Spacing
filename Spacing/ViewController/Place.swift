...
class ChildPlace: Place {
    var totalPrice: Int
    
    init(title: String, categories: Categories, position: String, images: [UIImage], description: String, isBooked: Bool, rating: Double, price: Int, totalPrice: Int) {
        self.totalPrice = totalPrice
        super.init(title: title, categories: categories, position: position, images: images, description: description, isBooked: isBooked, rating: rating, price: price)
    }
}
